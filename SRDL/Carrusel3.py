...
left_button = tk.Button(root, command=move_left, height=600, width=400)
center_button = tk.Button(root, command=handle_center_button, height=650, width=450)
right_button = tk.Button(root, command=move_right, height=600, width=400)
